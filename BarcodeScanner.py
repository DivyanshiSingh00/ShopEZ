    ...
    for y in range(image_height):
        for x in range(image_width):
            if y == 0 or y == image_height - 1 or x == 0 or x == image_width - 1:
                ...
                vertical_edges[y][x] = abs(
                    (pixel_array[y - 1][x - 1] * 1 + pixel_array[y - 1][x] * 0 + pixel_array[y - 1][x + 1] * -1 +
    ...
    for y in range(image_height):
        for x in range(image_width):
            if y == 0 or y == image_height - 1 or x == 0 or x == image_width - 1:
                ...
                horizontal_edges[y][x] = abs(
                    (pixel_array[y - 1][x - 1] * 1 + pixel_array[y - 1][x] * 2 + pixel_array[y - 1][x + 1] * 1 +
...
def main():
    ...
    edges = computeStrongVerticalEdgesBySubtractingHorizontal(vertical_edges, horizontal_edges, image_width,
                                                              image_height)
